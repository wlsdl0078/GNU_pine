...
<!-------------------------- 수정해서 사용하세욧 -------------------------->
<meta name="description" content="파인비치, 해남골프호텔,해남골프라운딩, 파인비치골프, 해남파인비치골프링크스">
<meta property="og:type" content="website">
<meta property="og:title" content="Pine beach golf links">
<meta property="og:description" content="골프링크스, 해남파인비치, 해남골프링크스, 파인비치 골프라운딩, 파인비치골프호텔">
<meta property="og:image" content="http://flower.ety.kr/theme/ety_theme_wide/img/SEO-PINE.png">
<meta property="og:url" content="http://wlsdl0078.cafe24.com/">
<!-------------------------- ./수정해서 사용하세요 -------------------------->



<!-------------------------- 네비게이션 -------------------------->
<div class="container-fluid top-line fixed-header d_n">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div id="tnb-left">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white fixed-top">
  <div class="d-flex w-100 align-items-center px-5">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive" data-hover="dropdown" data-animations="fadeIn fadeIn fadeInUp fadeInRight">
	  <ul class="navbar-nav ml-auto">
		...
		?>
			<?php if($row['sub']['0']) { ?>
				<li class="nav-item">
					<a class="nav-link dropdown-toggle ks4 f20" href="<?php echo $row['me_link']; ?>" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" target="_<?php echo $row['me_target']; ?>">
